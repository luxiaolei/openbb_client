...
class FMPRevenueBusinessLineData(BaseModel):
    """
    ...
    business_line: Optional[StrictStr] = None
    revenue: Revenue
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["period_ending", "fiscal_period", "fiscal_year", "filing_date", "business_line", "revenue"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if business_line (nullable) is None
        # and model_fields_set contains the field
        if self.business_line is None and "business_line" in self.model_fields_set:
            _dict['business_line'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "business_line": obj.get("business_line"),
            "revenue": Revenue.from_dict(obj["revenue"]) if obj.get("revenue") is not None else None
        })
