...
class TiingoWorldNewsData(BaseModel):
    """
    ...
    article_id: StrictInt = Field(description="Unique ID of the news article.")
    site: StrictStr = Field(description="News source.")
    tags: Optional[StrictStr] = None
    crawl_date: datetime = Field(description="Date the news article was crawled.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "title", "images", "text", "url", "symbols", "article_id", "site", "tags", "crawl_date"]
