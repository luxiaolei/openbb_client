...
class IntrinioInsiderTradingData(BaseModel):
    """
    ...
    company_name: StrictStr = Field(description="Name of the company.")
    ...
    underlying_shares: Optional[UnderlyingShares] = None
    ...
    other_relation: Optional[StrictBool] = None
    derivative_transaction: Optional[StrictBool] = None
    report_line_number: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "company_cik", "filing_date", "transaction_date", "owner_cik", "owner_name", "owner_title", "transaction_type", "acquisition_or_disposition", "security_type", "securities_owned", "securities_transacted", "transaction_price", "filing_url", "company_name", "conversion_exercise_price", "deemed_execution_date", "exercise_date", "expiration_date", "underlying_security_title", "underlying_shares", "nature_of_ownership", "director", "officer", "ten_percent_owner", "other_relation", "derivative_transaction", "report_line_number"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of underlying_shares
        if self.underlying_shares:
            _dict['underlying_shares'] = self.underlying_shares.to_dict()
        ...
        # set to None if underlying_shares (nullable) is None
        # and model_fields_set contains the field
        if self.underlying_shares is None and "underlying_shares" in self.model_fields_set:
            _dict['underlying_shares'] = None
        ...
        # set to None if other_relation (nullable) is None
        # and model_fields_set contains the field
        if self.other_relation is None and "other_relation" in self.model_fields_set:
            _dict['other_relation'] = None

        # set to None if derivative_transaction (nullable) is None
        # and model_fields_set contains the field
        if self.derivative_transaction is None and "derivative_transaction" in self.model_fields_set:
            _dict['derivative_transaction'] = None

        # set to None if report_line_number (nullable) is None
        # and model_fields_set contains the field
        if self.report_line_number is None and "report_line_number" in self.model_fields_set:
            _dict['report_line_number'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "underlying_shares": UnderlyingShares.from_dict(obj["underlying_shares"]) if obj.get("underlying_shares") is not None else None,
            ...
            "other_relation": obj.get("other_relation"),
            "derivative_transaction": obj.get("derivative_transaction"),
            "report_line_number": obj.get("report_line_number")
        })
