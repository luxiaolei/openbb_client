...
class FMPForwardEbitdaEstimatesData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["symbol", "name", "last_updated", "period_ending", "fiscal_year", "fiscal_period", "calendar_year", "calendar_period", "low_estimate", "high_estimate", "mean", "median", "standard_deviation", "number_of_analysts"]
