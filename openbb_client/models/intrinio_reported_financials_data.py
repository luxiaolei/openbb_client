...
class IntrinioReportedFinancialsData(BaseModel):
    """
    ...
    """ # noqa: E501
    period_ending: date = Field(description="The ending date of the reporting period.")
    fiscal_period: StrictStr = Field(description="The fiscal period of the report (e.g. FY, Q1, etc.).")
    fiscal_year: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["period_ending", "fiscal_period", "fiscal_year"]
