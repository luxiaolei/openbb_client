...
class IntrinioHistoricalMarketCapData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["date", "symbol", "market_cap"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "market_cap": MarketCap.from_dict(obj["market_cap"]) if obj.get("market_cap") is not None else None
        })
