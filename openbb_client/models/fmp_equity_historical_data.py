...
class FMPEquityHistoricalData(BaseModel):
    """
    ...
    unadjusted_volume: Optional[Union[StrictFloat, StrictInt]] = None
    change: Optional[Union[StrictFloat, StrictInt]] = None
    change_percent: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "open", "high", "low", "close", "volume", "vwap", "adj_close", "unadjusted_volume", "change", "change_percent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if unadjusted_volume (nullable) is None
        # and model_fields_set contains the field
        if self.unadjusted_volume is None and "unadjusted_volume" in self.model_fields_set:
            _dict['unadjusted_volume'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unadjusted_volume": obj.get("unadjusted_volume"),
