...
class OBBjectPetroleumStatusReport(BaseModel):
    """
    OBBject with results of type PetroleumStatusReport
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    results: Optional[List[EiaPetroleumStatusReportData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "results": [EiaPetroleumStatusReportData.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
