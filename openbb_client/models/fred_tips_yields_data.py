...
class FredTipsYieldsData(BaseModel):
    """
    ...
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The yield value.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "due", "name", "value"]
