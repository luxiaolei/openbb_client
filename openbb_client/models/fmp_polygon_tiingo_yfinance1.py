...
FMPPOLYGONTIINGOYFINANCE1_ANY_OF_SCHEMAS = ["str"]

class FmpPolygonTiingoYfinance1(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FmpPolygonTiingoYfinance1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FmpPolygonTiingoYfinance1 with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FmpPolygonTiingoYfinance1 with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
