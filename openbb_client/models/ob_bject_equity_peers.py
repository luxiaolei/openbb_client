...
class OBBjectEquityPeers(BaseModel):
    """
    OBBject with results of type EquityPeers
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    results: Optional[FMPEquityPeersData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "results": FMPEquityPeersData.from_dict(obj["results"]) if obj.get("results") is not None else None,
