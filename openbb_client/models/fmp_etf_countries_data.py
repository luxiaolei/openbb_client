...
class FMPEtfCountriesData(BaseModel):
    """
    FMP ETF Countries Data.
    """ # noqa: E501
    country: StrictStr = Field(description="The country of the exposure.  Corresponding values are normalized percentage points.")
