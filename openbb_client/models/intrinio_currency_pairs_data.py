...
class IntrinioCurrencyPairsData(BaseModel):
    """
    ...
    base_currency: StrictStr = Field(description="ISO 4217 currency code of the base currency.")
    quote_currency: StrictStr = Field(description="ISO 4217 currency code of the quote currency.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "name", "base_currency", "quote_currency"]
