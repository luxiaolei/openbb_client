...
class FederalReserveOvernightBankFundingRateData(BaseModel):
    """
    FederalReserve Overnight Bank Funding Rate Data.
    """ # noqa: E501
    var_date: date = Field(description="The date of the data.", alias="date")
    rate: Union[StrictFloat, StrictInt] = Field(description="Overnight Bank Funding Rate.")
    ...
    __properties: ClassVar[List[str]] = ["date", "rate", "percentile_1", "percentile_25", "percentile_75", "percentile_99", "volume", "revision_indicator"]
