...
class FederalReservePrimaryDealerPositioningData(BaseModel):
    """
    ...
    value: StrictInt = Field(description="The reported value of the net position (long - short), in millions of $USD.")
    name: StrictStr = Field(description="Short name for the series.")
    title: StrictStr = Field(description="Title of the series.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "value", "name", "title"]
