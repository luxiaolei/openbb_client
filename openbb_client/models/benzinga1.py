...
BENZINGA1_ANY_OF_SCHEMAS = ["List[str]", "str"]

class Benzinga1(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = Benzinga1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Benzinga1 with anyOf schemas: List[str], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Benzinga1 with anyOf schemas: List[str], str. Details: " + ", ".join(error_messages))
        else:
            return instance
