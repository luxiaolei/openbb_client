...
class FredMortgageIndicesData(BaseModel):
    """
    ...
    rate: Union[StrictFloat, StrictInt] = Field(description="Mortgage rate.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "name", "rate"]
