...
class FMPCryptoSearchData(BaseModel):
    """
    FMP Crypto Search Data.
    """ # noqa: E501
    symbol: StrictStr = Field(description="Symbol representing the entity requested in the data. (Crypto)")
    name: Optional[StrictStr] = None
    currency: Optional[StrictStr] = None
    exchange: Optional[StrictStr] = None
    exchange_name: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "name", "currency", "exchange", "exchange_name"]
