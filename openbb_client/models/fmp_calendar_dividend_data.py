...
class FMPCalendarDividendData(BaseModel):
    """
    ...
    adjusted_amount: Optional[Union[StrictFloat, StrictInt]] = None
    label: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ex_dividend_date", "symbol", "amount", "name", "record_date", "payment_date", "declaration_date", "adjusted_amount", "label"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if adjusted_amount (nullable) is None
        # and model_fields_set contains the field
        if self.adjusted_amount is None and "adjusted_amount" in self.model_fields_set:
            _dict['adjusted_amount'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adjusted_amount": obj.get("adjusted_amount"),
            "label": obj.get("label")
        })
