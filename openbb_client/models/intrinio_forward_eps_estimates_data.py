...
class IntrinioForwardEpsEstimatesData(BaseModel):
    """
    ...
    low_estimate: Optional[Union[StrictFloat, StrictInt]] = None
    high_estimate: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    revisions_change_percent: Optional[Union[StrictFloat, StrictInt]] = None
    mean_1w: Optional[Union[StrictFloat, StrictInt]] = None
    mean_1m: Optional[Union[StrictFloat, StrictInt]] = None
    mean_2m: Optional[Union[StrictFloat, StrictInt]] = None
    mean_3m: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "name", "date", "fiscal_year", "fiscal_period", "calendar_year", "calendar_period", "low_estimate", "high_estimate", "mean", "median", "standard_deviation", "number_of_analysts", "revisions_change_percent", "mean_1w", "mean_1m", "mean_2m", "mean_3m"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if revisions_change_percent (nullable) is None
        # and model_fields_set contains the field
        if self.revisions_change_percent is None and "revisions_change_percent" in self.model_fields_set:
            _dict['revisions_change_percent'] = None

        # set to None if mean_1w (nullable) is None
        # and model_fields_set contains the field
        if self.mean_1w is None and "mean_1w" in self.model_fields_set:
            _dict['mean_1w'] = None

        # set to None if mean_1m (nullable) is None
        # and model_fields_set contains the field
        if self.mean_1m is None and "mean_1m" in self.model_fields_set:
            _dict['mean_1m'] = None

        # set to None if mean_2m (nullable) is None
        # and model_fields_set contains the field
        if self.mean_2m is None and "mean_2m" in self.model_fields_set:
            _dict['mean_2m'] = None

        # set to None if mean_3m (nullable) is None
        # and model_fields_set contains the field
        if self.mean_3m is None and "mean_3m" in self.model_fields_set:
            _dict['mean_3m'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "revisions_change_percent": obj.get("revisions_change_percent"),
            "mean_1w": obj.get("mean_1w"),
            "mean_1m": obj.get("mean_1m"),
            "mean_2m": obj.get("mean_2m"),
            "mean_3m": obj.get("mean_3m")
        })
