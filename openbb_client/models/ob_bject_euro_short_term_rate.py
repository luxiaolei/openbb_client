...
class OBBjectEuroShortTermRate(BaseModel):
    """
    OBBject with results of type EuroShortTermRate
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    results: Optional[List[FredEuroShortTermRateData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "results": [FredEuroShortTermRateData.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
