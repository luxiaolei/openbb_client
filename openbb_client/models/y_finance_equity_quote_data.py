...
class YFinanceEquityQuoteData(BaseModel):
    ...
    volume_average: Optional[Union[StrictFloat, StrictInt]] = None
    volume_average_10d: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "asset_type", "name", "exchange", "bid", "bid_size", "bid_exchange", "ask", "ask_size", "ask_exchange", "quote_conditions", "quote_indicators", "sales_conditions", "sequence_number", "market_center", "participant_timestamp", "trf_timestamp", "sip_timestamp", "last_price", "last_tick", "last_size", "last_timestamp", "open", "high", "low", "close", "volume", "exchange_volume", "prev_close", "change", "change_percent", "year_high", "year_low", "ma_50d", "ma_200d", "volume_average", "volume_average_10d", "currency"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if volume_average (nullable) is None
        # and model_fields_set contains the field
        if self.volume_average is None and "volume_average" in self.model_fields_set:
            _dict['volume_average'] = None

        # set to None if volume_average_10d (nullable) is None
        # and model_fields_set contains the field
        if self.volume_average_10d is None and "volume_average_10d" in self.model_fields_set:
            _dict['volume_average_10d'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "volume_average": obj.get("volume_average"),
            "volume_average_10d": obj.get("volume_average_10d"),
