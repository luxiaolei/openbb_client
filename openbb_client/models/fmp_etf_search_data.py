...
class FMPEtfSearchData(BaseModel):
    """
    FMP ETF Search Data.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["symbol", "name", "market_cap", "sector", "industry", "beta", "price", "last_annual_dividend", "volume", "exchange", "exchange_name", "country", "actively_trading"]
