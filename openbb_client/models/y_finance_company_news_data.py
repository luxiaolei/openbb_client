...
class YFinanceCompanyNewsData(BaseModel):
    """
    ...
    source: StrictStr = Field(description="Source of the news article")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "title", "text", "images", "url", "symbols", "source"]
