...
class FMPCalendarSplitsData(BaseModel):
    """
    FMP Calendar Splits Data.
    """ # noqa: E501
    var_date: date = Field(description="The date of the data.", alias="date")
    label: StrictStr = Field(description="Label of the stock splits.")
    symbol: StrictStr = Field(description="Symbol representing the entity requested in the data.")
    numerator: Union[StrictFloat, StrictInt] = Field(description="Numerator of the stock splits.")
    denominator: Union[StrictFloat, StrictInt] = Field(description="Denominator of the stock splits.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "label", "symbol", "numerator", "denominator"]
