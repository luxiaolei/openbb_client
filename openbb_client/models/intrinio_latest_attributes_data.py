...
class IntrinioLatestAttributesData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["symbol", "tag", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag": obj.get("tag"),
            "value": Value7.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
