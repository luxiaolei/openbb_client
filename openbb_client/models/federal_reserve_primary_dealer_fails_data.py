...
class FederalReservePrimaryDealerFailsData(BaseModel):
    """
    ...
    title: StrictStr = Field(description="Title of the series' symbol.")
    value: Value5
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "title", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "value": Value5.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
