...
class FredCommoditySpotPricesData(BaseModel):
    """
    ...
    price: Union[StrictFloat, StrictInt] = Field(description="Price of the commodity.")
    unit: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "commodity", "price", "unit"]
