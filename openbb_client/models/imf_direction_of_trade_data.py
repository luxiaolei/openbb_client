...
class ImfDirectionOfTradeData(BaseModel):
    """
    ...
    country: StrictStr
    counterpart: StrictStr = Field(description="Counterpart country or region to the trade.")
    title: Optional[StrictStr] = None
    value: Union[StrictFloat, StrictInt] = Field(description="Trade value.")
    scale: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "country", "counterpart", "title", "value", "scale"]
