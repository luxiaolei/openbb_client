...
class FredRegionalData(BaseModel):
    """
    FRED Regional Data.
    """ # noqa: E501
    var_date: date = Field(description="The date of the data.", alias="date")
    region: StrictStr = Field(description="The name of the region.")
    code: Code
    value: Optional[Value6] = None
    series_id: StrictStr = Field(description="The individual series ID for the region.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "region", "code", "value", "series_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": Value6.from_dict(obj["value"]) if obj.get("value") is not None else None,
