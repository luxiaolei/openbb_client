...
class OBBjectSelectedTreasuryConstantMaturity(BaseModel):
    """
    OBBject with results of type SelectedTreasuryConstantMaturity
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    results: Optional[List[FREDSelectedTreasuryConstantMaturityData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "results": [FREDSelectedTreasuryConstantMaturityData.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
