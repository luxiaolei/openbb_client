...
class FredSeniorLoanOfficerSurveyData(BaseModel):
    """
    FRED Senior Loan Officer Opinion Survey Data.
    """ # noqa: E501
    var_date: date = Field(description="The date of the data.", alias="date")
    symbol: Optional[StrictStr] = None
    value: Union[StrictFloat, StrictInt] = Field(description="Survey value.")
    title: Optional[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "value", "title"]
