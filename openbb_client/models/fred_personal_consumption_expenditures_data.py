...
class FredPersonalConsumptionExpendituresData(BaseModel):
    """
    ...
    name: StrictStr = Field(description="The name of the series.")
    element_id: StrictStr = Field(description="The element id in the parent/child relationship.")
    parent_id: StrictStr = Field(description="The parent id in the parent/child relationship.")
    children: Optional[StrictStr] = None
    level: StrictInt = Field(description="The indentation level of the element.")
    line: StrictInt = Field(description="The line number of the series in the table.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "value", "name", "element_id", "parent_id", "children", "level", "line"]
