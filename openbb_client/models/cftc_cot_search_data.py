...
class CftcCotSearchData(BaseModel):
    """
    CFTC Commitment of Traders Reports Search Data.
    """ # noqa: E501
    code: StrictStr = Field(description="CFTC market contract code of the report.")
    name: StrictStr = Field(description="Name of the underlying asset.")
    ...
    __properties: ClassVar[List[str]] = ["code", "name", "category", "subcategory", "units", "symbol", "commodity"]
