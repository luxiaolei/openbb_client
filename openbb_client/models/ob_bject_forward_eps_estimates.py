...
class OBBjectForwardEpsEstimates(BaseModel):
    """
    OBBject with results of type ForwardEpsEstimates
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    results: Optional[List[OBBjectForwardEpsEstimatesResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "results": [OBBjectForwardEpsEstimatesResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
