...
class IntrinioEquitySearchData(BaseModel):
    """
    ...
    lei: Optional[StrictStr]
    intrinio_id: StrictStr = Field(description="The Intrinio ID of the company.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "name", "cik", "lei", "intrinio_id"]
