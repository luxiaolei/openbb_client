...
class YFinanceEquityProfileData(BaseModel):
    """
    ...
    shares_float: Optional[StrictInt] = None
    shares_implied_outstanding: Optional[StrictInt] = None
    shares_short: Optional[StrictInt] = None
    dividend_yield: Optional[Union[StrictFloat, StrictInt]] = None
    beta: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "name", "cik", "cusip", "isin", "lei", "legal_name", "stock_exchange", "sic", "short_description", "long_description", "ceo", "company_url", "business_address", "mailing_address", "business_phone_no", "hq_address_1", "hq_address_2", "hq_address_city", "hq_address_postal_code", "hq_state", "hq_country", "inc_state", "inc_country", "employees", "entity_legal_form", "entity_status", "latest_filing_date", "irs_number", "sector", "industry_category", "industry_group", "template", "standardized_active", "first_fundamental_date", "last_fundamental_date", "first_stock_price_date", "last_stock_price_date", "exchange_timezone", "issue_type", "currency", "market_cap", "shares_outstanding", "shares_float", "shares_implied_outstanding", "shares_short", "dividend_yield", "beta"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if shares_float (nullable) is None
        # and model_fields_set contains the field
        if self.shares_float is None and "shares_float" in self.model_fields_set:
            _dict['shares_float'] = None

        # set to None if shares_implied_outstanding (nullable) is None
        # and model_fields_set contains the field
        if self.shares_implied_outstanding is None and "shares_implied_outstanding" in self.model_fields_set:
            _dict['shares_implied_outstanding'] = None

        # set to None if shares_short (nullable) is None
        # and model_fields_set contains the field
        if self.shares_short is None and "shares_short" in self.model_fields_set:
            _dict['shares_short'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shares_float": obj.get("shares_float"),
            "shares_implied_outstanding": obj.get("shares_implied_outstanding"),
            "shares_short": obj.get("shares_short"),
