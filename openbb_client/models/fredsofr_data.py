...
class FREDSOFRData(BaseModel):
    ...
    average_30d: Optional[Union[StrictFloat, StrictInt]] = None
    average_90d: Optional[Union[StrictFloat, StrictInt]] = None
    average_180d: Optional[Union[StrictFloat, StrictInt]] = None
    index: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "rate", "percentile_1", "percentile_25", "percentile_75", "percentile_99", "volume", "average_30d", "average_90d", "average_180d", "index"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if average_30d (nullable) is None
        # and model_fields_set contains the field
        if self.average_30d is None and "average_30d" in self.model_fields_set:
            _dict['average_30d'] = None

        # set to None if average_90d (nullable) is None
        # and model_fields_set contains the field
        if self.average_90d is None and "average_90d" in self.model_fields_set:
            _dict['average_90d'] = None

        # set to None if average_180d (nullable) is None
        # and model_fields_set contains the field
        if self.average_180d is None and "average_180d" in self.model_fields_set:
            _dict['average_180d'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "average_30d": obj.get("average_30d"),
            "average_90d": obj.get("average_90d"),
            "average_180d": obj.get("average_180d"),
            "index": obj.get("index")
        })
