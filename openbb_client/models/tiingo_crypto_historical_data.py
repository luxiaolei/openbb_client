...
class TiingoCryptoHistoricalData(BaseModel):
    """
    ...
    volume: Union[StrictFloat, StrictInt] = Field(description="The trading volume.")
    vwap: Optional[Union[StrictFloat, StrictInt]] = None
    transactions: Optional[StrictInt] = None
    volume_notional: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "open", "high", "low", "close", "volume", "vwap", "transactions", "volume_notional"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if volume_notional (nullable) is None
        # and model_fields_set contains the field
        if self.volume_notional is None and "volume_notional" in self.model_fields_set:
            _dict['volume_notional'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "volume_notional": obj.get("volume_notional")
        })
