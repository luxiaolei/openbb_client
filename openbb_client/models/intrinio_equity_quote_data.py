...
class IntrinioEquityQuoteData(BaseModel):
    ...
    is_darkpool: Optional[StrictBool] = None
    source: Optional[StrictStr] = None
    updated_on: datetime = Field(description="Date and Time when the data was last updated.")
    security: Optional[IntrinioSecurity] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["symbol", "asset_type", "name", "exchange", "bid", "bid_size", "bid_exchange", "ask", "ask_size", "ask_exchange", "quote_conditions", "quote_indicators", "sales_conditions", "sequence_number", "market_center", "participant_timestamp", "trf_timestamp", "sip_timestamp", "last_price", "last_tick", "last_size", "last_timestamp", "open", "high", "low", "close", "volume", "exchange_volume", "prev_close", "change", "change_percent", "year_high", "year_low", "is_darkpool", "source", "updated_on", "security"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if is_darkpool (nullable) is None
        # and model_fields_set contains the field
        if self.is_darkpool is None and "is_darkpool" in self.model_fields_set:
            _dict['is_darkpool'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_darkpool": obj.get("is_darkpool"),
