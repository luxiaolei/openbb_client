...
class PolygonCompanyNewsData(BaseModel):
    """
    ...
    amp_url: Optional[StrictStr] = None
    publisher: PolygonPublisher = Field(description="Publisher of the article.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "title", "text", "images", "url", "symbols", "source", "tags", "id", "amp_url", "publisher"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if amp_url (nullable) is None
        # and model_fields_set contains the field
        if self.amp_url is None and "amp_url" in self.model_fields_set:
            _dict['amp_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "id": obj.get("id"),
            "amp_url": obj.get("amp_url"),
            "publisher": PolygonPublisher.from_dict(obj["publisher"]) if obj.get("publisher") is not None else None
        })
