...
class FredFederalFundsRateData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["date", "rate", "target_range_upper", "target_range_lower", "percentile_1", "percentile_25", "percentile_75", "percentile_99", "volume"]
