...
class OBBjectSchemaFiles(BaseModel):
    """
    OBBject with results of type SchemaFiles
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    results: Optional[SecSchemaFilesData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "results": SecSchemaFilesData.from_dict(obj["results"]) if obj.get("results") is not None else None,
