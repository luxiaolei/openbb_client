...
class YFinanceOptionsChainsData(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vega": obj.get("vega"),
            "rho": obj.get("rho"),
            "in_the_money": obj.get("in_the_money"),
