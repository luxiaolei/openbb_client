...
class FredBondIndicesData(BaseModel):
    """
    FRED Bond Indices Data.
    """ # noqa: E501
    var_date: date = Field(description="The date of the data.", alias="date")
    symbol: Optional[StrictStr] = None
    value: Union[StrictFloat, StrictInt] = Field(description="Index values.")
    maturity: Optional[StrictStr] = None
    title: StrictStr = Field(description="The title of the index.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "symbol", "value", "maturity", "title"]
