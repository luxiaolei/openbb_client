...
json = "{}"
# create an instance of YFLosersData from a JSON string
yf_losers_data_instance = YFLosersData.from_json(json)
# print the JSON string representation of the object
print(YFLosersData.to_json())

# convert the object into a dict
yf_losers_data_dict = yf_losers_data_instance.to_dict()
# create an instance of YFLosersData from a dict
yf_losers_data_from_dict = YFLosersData.from_dict(yf_losers_data_dict)
```
