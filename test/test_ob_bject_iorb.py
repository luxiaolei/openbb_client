...
class TestOBBjectIORB(unittest.TestCase):
    """OBBjectIORB unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBBjectIORB:
        """Test OBBjectIORB
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBBjectIORB`
        """
        model = OBBjectIORB()
        if include_optional:
            return OBBjectIORB(
