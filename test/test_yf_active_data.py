...
class TestYFActiveData(unittest.TestCase):
    """YFActiveData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YFActiveData:
        """Test YFActiveData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YFActiveData`
        """
        model = YFActiveData()
        if include_optional:
            return YFActiveData(
