...
class TestOBBjectEquityInfoResultsInner(unittest.TestCase):
    """OBBjectEquityInfoResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBBjectEquityInfoResultsInner:
        """Test OBBjectEquityInfoResultsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBBjectEquityInfoResultsInner`
        """
        model = OBBjectEquityInfoResultsInner()
        if include_optional:
            return OBBjectEquityInfoResultsInner(
                symbol = '',
                name = '',
                cik = '',
                cusip = '',
    ...
    def testOBBjectEquityInfoResultsInner(self):
        """Test OBBjectEquityInfoResultsInner"""
