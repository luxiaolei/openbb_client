...
class TestIntrinioEtfInfoData(unittest.TestCase):
    """IntrinioEtfInfoData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntrinioEtfInfoData:
        """Test IntrinioEtfInfoData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntrinioEtfInfoData`
        """
        model = IntrinioEtfInfoData()
        if include_optional:
            return IntrinioEtfInfoData(
                symbol = '',
                name = '',
                description = '',
                inception_date = '',
    ...
    def testIntrinioEtfInfoData(self):
        """Test IntrinioEtfInfoData"""
