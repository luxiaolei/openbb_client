...
class TestOBBjectSOFR(unittest.TestCase):
    """OBBjectSOFR unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBBjectSOFR:
        """Test OBBjectSOFR
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBBjectSOFR`
        """
        model = OBBjectSOFR()
        if include_optional:
            return OBBjectSOFR(
