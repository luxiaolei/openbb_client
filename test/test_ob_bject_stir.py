...
class TestOBBjectSTIR(unittest.TestCase):
    """OBBjectSTIR unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBBjectSTIR:
        """Test OBBjectSTIR
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBBjectSTIR`
        """
        model = OBBjectSTIR()
        if include_optional:
            return OBBjectSTIR(
