...
class TestSecEtfHoldingsData(unittest.TestCase):
    """SecEtfHoldingsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecEtfHoldingsData:
        """Test SecEtfHoldingsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SecEtfHoldingsData`
        """
        model = SecEtfHoldingsData()
        if include_optional:
            return SecEtfHoldingsData(
                symbol = '',
                name = '',
                lei = '',
                cusip = '',
    ...
    def testSecEtfHoldingsData(self):
        """Test SecEtfHoldingsData"""
