...
class TestFMPFinancialRatiosData(unittest.TestCase):
    """FMPFinancialRatiosData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FMPFinancialRatiosData:
        """Test FMPFinancialRatiosData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FMPFinancialRatiosData`
        """
        model = FMPFinancialRatiosData()
        if include_optional:
            return FMPFinancialRatiosData(
                period_ending = '',
                fiscal_period = '',
                fiscal_year = 56,
                current_ratio = 1.337,
    ...
    def testFMPFinancialRatiosData(self):
        """Test FMPFinancialRatiosData"""
