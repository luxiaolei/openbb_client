...
class TestOBBjectLTIR(unittest.TestCase):
    """OBBjectLTIR unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBBjectLTIR:
        """Test OBBjectLTIR
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBBjectLTIR`
        """
        model = OBBjectLTIR()
        if include_optional:
            return OBBjectLTIR(
