...
class TestYFGainersData(unittest.TestCase):
    """YFGainersData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YFGainersData:
        """Test YFGainersData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YFGainersData`
        """
        model = YFGainersData()
        if include_optional:
            return YFGainersData(
                symbol = '',
                name = '',
                price = 1.337,
                change = 1.337,
