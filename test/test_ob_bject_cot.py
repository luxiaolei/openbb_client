...
class TestOBBjectCOT(unittest.TestCase):
    """OBBjectCOT unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBBjectCOT:
        """Test OBBjectCOT
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBBjectCOT`
        """
        model = OBBjectCOT()
        if include_optional:
            return OBBjectCOT(
